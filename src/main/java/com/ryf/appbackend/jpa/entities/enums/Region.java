...
public enum Region {
    ...
    private static final Map<String, Region> alpha3Map = new HashMap<String, Region>();
    private static final Map<Integer, Region> numericMap = new HashMap<Integer, Region>();


    static {
        for (Region cc : values()) {
    ...
    private Region(String name, String alpha3, int numeric) {
        this.name = name;
        this.alpha3 = alpha3;
    ...
    /**
     * Get a Region that corresponds to a given ISO 3166-1
     ...
     *             >alpha-3</a> code.
     * @return A Region instance, or null if not found.
     */
    ...
    private static Region getByAlpha3Code(String code) {
        return alpha3Map.get(code);
    }


    /**
     * Get a Region that corresponds to a given
